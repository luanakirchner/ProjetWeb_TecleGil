...
?>
    <div class="login-dark" style="background-image: url(&quot;img/test2.png&quot;);">
        <form class="FormLogin" method="post" action='index.php?action=Login'>
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(210,183,43);">Login</button></div><a class="forgot" href="index.php?action=MotDePasseOblie">Mot de passe oublié?&nbsp;</a></form>
    </div>
<?php
